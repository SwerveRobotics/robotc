...
#pragma config(Motor,  mtr_S1_C3_1,     BlockLifter,   tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C3_2,     Flag,          tmotorTetrix, openLoop)
#pragma config(Servo,  srvo_S1_C4_1,    GearChanger,          tServoStandard)
#pragma config(Servo,  srvo_S1_C4_2,    TurnTable,            tServoContinuousRotation)
#pragma config(Servo,  srvo_S1_C4_3,    HookLifter,           tServoContinuousRotation)
...
task main()
{
	...
	if (isbasketbasket4 == true)
	{
			...
			motor[BlockLifter] = StallCode(BlockLifter, (100));
			wait1Msec(1000);
			motor[BlockLifter] = StallCode(BlockLifter, (0));
		...
		if (SensorValue[IRseeker] == 3)
	{
		...
		motor[BlockLifter] = StallCode(BlockLifter, (40));
		wait1Msec(1000);
		motor[BlockLifter] = StallCode(BlockLifter, (0));
