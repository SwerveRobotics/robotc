...
/* Code Review by Darrell
 - Since you are in ftc6220, there is no need for the first two entries in your #include-> "../ftc6220/" is unnecessary
 - *Good use of functions.*
 - Maybe have a servo_functions.c file where you place them?
 - Should use defined values with descriptive names instead of magic numbers.
 - File does not compile. THe functions in manipulators.c are duplicated here. Remove them?
*/
