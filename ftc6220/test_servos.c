...
/* Code Review by Darrell
 - File lacks comments explainging what it is doing.
 - Descriptive name does not explain lines of servo control.
 - *Good naming matches style guide.*
*/
...
task main()
{
	...
	while(true)
	{
		...
		{
			servo[FRONT_LEFT_SERVO] = 127 + 1.2 * (joystick.joy1_y2 - 15);            // What does this do?
