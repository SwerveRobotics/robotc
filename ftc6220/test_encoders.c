...
/* Code Review by Darrell
 - File desperately needs comments explaing what it is doing.
*/
...
task main()
{
	...
	while(true)
	{
		...
		if (nib == true)
		{
			DegToCRServo(FRONT_LEFT_SERVO, FRONT_RIGHT_MOTOR, ang); // instead of doing this, why not execute this prior to while-loop?
			                                                        // or you might look into a do-while loop
		}
		nib = false;
