...
/* Code Review by Darrell
 - *Great use of comments to provide setup instructions.*
 - *Good use of includes to reduce complexity.*
 - *Good use of comments explaining code.*
 - File does not compile.
 - File name does not meet style guide rules -> drive_off_ramp.c
*/
