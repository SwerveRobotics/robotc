...
task main()
{
	...
	while(true)
	{
		nxtDisplayTextLine(3, "%f", GetCRServoPosition(FRONT_LEFT_MOTOR));
		nxtDisplayTextLine(4, "%f", GetCRServoPosition(FRONT_RIGHT_MOTOR));
		nxtDisplayTextLine(5, "%f", GetCRServoPosition(BACK_LEFT_MOTOR));
		nxtDisplayTextLine(6, "%f", GetCRServoPosition(BACK_RIGHT_MOTOR));
		wait1Msec(100);
	}
}
