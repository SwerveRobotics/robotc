...
/* Code Review by Darrell
 ...
 - *Very clean code.*
 - *Good descriptive names. Easy to read.*
 - *Great use of gyro for control.*

 - Could use comments about RampKickPos. What is that?
...
task main()
{
	...
	TurnLeftDegrees(55, 30);
	DriveBackwardDistanceGyro(27, 20);
