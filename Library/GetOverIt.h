...
BOOL FCarryingMagneticBaton()
    ...
    LockBlackboard();
    READ_SENSORS_CONTEXT context; InitializeReadSensorsContext(context, SENSOR_READ_FREQ_NORMAL);
...
BOOL DriveToWhiteLine(float cmDistance, float cmExtra, BACKGROUND background)
    ...
    //
    trig.fRequireTrigger  = true;
    trig.cmAdditional     = cmExtra;
    //
    ...
    case BACKGROUND_BLUE:
        ...
        sensEopdFront.fTriggerRequested = true;
    ...
    case BACKGROUND_RED:
        ...
        sensColor.fTriggerRequested = true;
        trig.cmAdditional -= dcmEopdFrontColor;     // TO DO: if this goes negative, the algorithm needs improvement
...
#endif
    //
    return DriveForwards(cmDistance, trig, power);
    }
...
// to dispense.
    ...
    InitializeTriggerConditions();
    trig.fRequireTrigger          = true;
    sensEopdArm.fTriggerRequested = true;
    sensEopdArm.target            = 10;
    sensEopdArm.comparison        = COMPARE_GT;
    RET_IF_FAIL(DriveForwards(55 * driveDirReflection,trig,30), "DriveToEOPD"); // 30
    ...
    RET_IF_FAIL(DriveForwards(-25 * driveDirReflection,trig,12), "FineTuneEOPD"); // v11 was power=20
