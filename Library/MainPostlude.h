...
//---------------------------------------------------------------------------
// Robot name management: we wish we could do this better
//---------------------------------------------------------------------------

// Make sure this is defined so we can compare against it in #if's in the code
//
#ifndef ROBOT_NAME
#define ROBOT_NAME                      0
#endif

// Define historical and well-known bots (if RobotConfig.h hasn't been included)
//
#ifndef ROBOT_NAME_FTC417_2010_V11
#define ROBOT_NAME_FTC417_2010_V11      1
#endif

#ifndef ROBOT_NAME_FTC417_2010_V12
#define ROBOT_NAME_FTC417_2010_V12      2
#endif

#ifndef ROBOT_NAME_OMNI_BOT
#define ROBOT_NAME_OMNI_BOT             3
#endif
